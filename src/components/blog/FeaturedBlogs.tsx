...
export default function FeaturedBlogs({title, subtitle, photo, alt}: {title: string, subtitle: string, photo: string, alt: string}){
    return (
        <div className={styles.featuredCardContainer}>
            <Image src={photo} height={320} width={400} alt={alt} style={{borderRadius: "20px 20px 0px 0px"}}/>
